void OdriveInit1() {
      ...
      for (int axis = 0; axis < 2; ++axis) {
          ...
          Serial3 << "w axis" << axis << ".motor.config.current_lim " << 25.0f << '\n';
          ...
          Serial3 << "w axis" << 0 << ".controller.config.vel_gain " << 0.2 << '\n';
          Serial3 << "w axis" << 1 << ".controller.config.vel_gain " << 0.2 << '\n';

          Serial3 << "w axis" << 0 << ".controller.config.vel_integrator_gain " << 10 << '\n';
          Serial3 << "w axis" << 1 << ".controller.config.vel_integrator_gain " << 10 << '\n';
      }   
